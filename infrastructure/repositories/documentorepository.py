from infrastructure.models import DocumentoDB
...
from infrastructure.models import UsuarioDB
...
class DocumentoRepository:
    ...
    def create_document_db(data, creado_por=None):
        ...
        tipo_entrega = TipoEntregaDB.objects.get(nombre=data['U_LED_TIPDEV'])
