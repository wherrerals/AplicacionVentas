...
from domain.services.trasportation import Trasnportation
...
class InvoiceSerializer:
    ...
    def serializer_sales_details(data_bp, data_lines):
        ...
        invoice_bp = {
            ...
            "Address": invoice_data.get("Address").split("\r")[0] if invoice_data.get("Address") else "",
            "Address2": invoice_data.get("Address2").split("\r")[0] if invoice_data.get("Address2") else "",
