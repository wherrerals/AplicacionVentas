...
function agergardireccion(){
    ...
    <div class="col-sm-12" style="width: 100%;height: 10px;"><span>&nbsp;</span></div>
      ...
      <div class="row">
        ...
        <div class="col"><input class="form-control" type="text" name="nombreDireccion" style="border-color: rgb(159,168,175);font-size: 12px;"> </div>
      </div>
      <div class="row">
        <div class="col-sm-4"><label class="col-form-label" style="font-size: 13px;">País</label></div>
        <div class="col"><select class="form-select" style="font-size: 12px;border-color: rgb(159,168,175);">
            <optgroup label="País">
    ...
    // document.getElementById('eliminar_dir').addEventListener('click', function() {
    //     // Obtener una referencia al padre del elemento que deseas eliminar
    //     var padre = newRow.parentNode;
    //     // Eliminar el elemento del DOM
    //     padre.removeChild(newRow);
    // });
        ...
        <div class="col-sm-5" style="font-size: 12px;background: #f0f2f5;width: 230px;">
            <div class="row">
                <div class="col-sm-12" style="height: 15px;background: transparent;">
                    ...
                    <div class="col" style="text-align: center;">
                        <span style="font-weight: bold;">Contacto Nº ${contcon} </span></div>
                            <div class="col-sm-12" style="height: 5px;background: transparent;">
                                            <span>&nbsp;</span>
                                          </div>
                                        </div>
            ...
            <a class="navbar-brand d-flex align-items-center"  style="width: 32px;">
                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-backspace" style="font-size: 24px;" id="eliminar_contacto">
                    ...
                    <path d="M13.683 1a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-7.08a2 2 0 0 1-1.519-.698L.241 8.65a1 1 0 0 1 0-1.302L5.084 1.7A2 2 0 0 1 6.603 1zm-7.08 1a1 1 0 0 0-.76.35L1 8l4.844 5.65a1 1 0 0 0 .759.35h7.08a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1z"> </path>
                                        ...
                                        <div class="row">
                                          <div class="col-sm-4"><label class="col-form-label"
                                              style="font-size: 13px;">Nombre</label></div>
                                        ...
                                        <div class="row">
                                          <div class="col-sm-4"><label class="col-form-label"
                                              style="font-size: 13px;">Apellido</label></div>
                                          <div class="col"><input class="form-control" type="text" name="pais"
                                              style="border-color: rgb(159,168,175);font-size: 12px;"></div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                          <div class="col-sm-4"><label class="col-form-label"
                                              style="font-size: 13px;">Email</label></div>
